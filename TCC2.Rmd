...
A seleção de covariáveis é uma etapa comumente realizada no processo de modelagem estatística. Os métodos de estimação retrativa  (*Shrinkage estimation*) têm se popularizado na literatura (Tibshirani, 1996).
...
![](A/Metricas_Intra.png)

## Métricas - Extra-amostrais

![](A/Metricas_Extra.png)
...
## Desempenho preditivo
```{r Intra, echo=FALSE, warning=FALSE}
tribble(
  ~'Modelo' , ~'Métrica', ~'UL'       , ~'WL'       , ~'PWL'       ,
  "RL"      , "ESP"     , "**0.804**" , "0.801"     , "0.800"      ,
  "RL"      , "SEN"     , "**0.475**" , "0.238"     , "0.403"      ,
  "RL"      , "ACC"     , "**0.777**" , "0.755"     , "0.767"      ,
  "RLA"     , "ESP"     , "**0.801**" , "**0.801**" , "**0.801**"  ,
  "RLA"     , "SEN"     , "**0.575**" , "0.569"     , "0.497"      ,
  "RLA"     , "ACC"     , "**0.783**" , "0.782"     , "0.776"      ,
  "RLAP"    , "ESP"     , "**0.805**" , "0.804"     , "0.802"      ,
  "RLAP"    , "SEN"     , "**0.613**" , "0.503"     , "0.564"      ,
  "RLAP"    , "ACC"     , "**0.789**" , "0.779"     , "0.783" )  %>% 
  knitr::kable(format = 'simple', caption = "Resultados Intra-amostrais")
```
...
tribble(
  ~'Modelo' , ~'Métrica', ~'UL'       , ~'WL'       , ~'PWL'      ,
  "RL"      , "ESP"     , "0.660"     , "**0.753**" , "0.694"     ,
  "RL"      , "SEN"     , "**0.392**" , "0.216"     , "0.255"     ,
  "RL"      , "ACC"     , "0.642"     , "**0.715**" , "0.663"     ,
  "RLA"     , "ESP"     , "0.691"     , "0.710"     , "**0.751**" ,
  "RLA"     , "SEN"     , "**0.451**" , "0.373"     , "0.294"     ,
  "RLA"     , "ACC"     , "0.674"     , "0.687"     , "**0.720**" ,
  "RLAP"    , "ESP"     , "0.735"     , "**0.783**" , "0.751"     ,
  "RLAP"    , "SEN"     , "**0.412**" , "0.255"     , "0.333"     ,
  "RLAP"    , "ACC"     , "0.713"     , "**0.746**" , "0.722" )  %>% 
  knitr::kable(format = 'simple', caption = "Resultados Extra-amostrais")
```
